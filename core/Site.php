 ...
 * 
 * Also contains methods for render HTML elements
 * such as div, label, input, table and so on.
 */
class Site
{
    /**
    ...
    {
        $this->sitename = "Rieltor Productions";
    ...
    public function RenderHeader()
    {
        ...
        $header .= $this->RenderHeaderMenuItem('Notary', 'notary.php');
